              ...
              <div className={styles.content__blockWrap}>
                ...
                <div className={styles.content__block}>
                  <ul className={styles.content__list}>
                    {proj.description?.list_1?.map((el, index) => (
                      <li
                        key={index}
                        className={`${styles.content__listItem} ${styles.content__listItem_listType}`}
                  ...
                  <ul className={`${styles.content__list} ${styles.content__list_type}`}>
                    {proj.description?.list_2?.map((el, index) => (
                      <li key={index} className={styles.content__listItem}>{el}</li>
                    ))}
                  </ul>
                </div>
              </div>
